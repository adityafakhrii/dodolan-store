        ...
        >
            <div className="space-y-6">
                ...
                <form
                    ...
                    className="rounded-2xl border border-slate-200 bg-white p-4 sm:p-8 shadow-xs dark:border-slate-800 dark:bg-slate-900 space-y-6"
                >
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className={`w-full min-h-[44px] rounded-xl border px-4 pl-10 py-2.5 text-xs text-slate-900 focus:outline-hidden dark:bg-slate-800 dark:text-white ${
                    ...
                    <div className="flex items-center justify-end pt-3 border-t border-slate-100 dark:border-slate-800">
                        <button
                            type="submit"
                            disabled={processing}
                            className="w-full sm:w-auto min-h-[44px] inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-xs transition disabled:opacity-50"
                        >
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-1">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-xs">
                                ...
                                <p className="text-slate-400 mt-0.5">Atur kata sandi baru untuk akses akun pelanggan Anda.</p>
                            </div>
                        </div>

                        <Link
                            href="/settings/security"
                            className="w-full sm:w-auto min-h-[44px] inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-xl border border-slate-200 text-xs font-bold text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800 transition"
                        >

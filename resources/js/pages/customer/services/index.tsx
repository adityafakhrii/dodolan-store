                        ...
                        >
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800 gap-2">
                                <div className="flex items-center gap-3">
                                    <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-950 dark:text-emerald-400">
                                ...
                                <span className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-bold ${getStatusBadge(item.status)}`}>
                                    {item.status}
                                </span>
                            </div>
                            ...
                            <div className="space-y-2 text-xs">
                                ...
                                <div className="pl-6 text-slate-600 dark:text-slate-400 leading-relaxed whitespace-pre-line">
                                    <strong>Deskripsi Kebutuhan:</strong><br />
                                    {item.description}
                                </div>
                                {item.note && (
                                    <div className="pl-6 text-[11px] italic text-slate-400">
